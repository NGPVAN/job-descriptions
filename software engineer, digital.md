...
If so, this is your opportunity to work on industry-leading applications and use the latest web technology while doing it.  Some things we work with:  Angular, ASP.NET (MVC and Web Api, latest versions), DynamoDB, Elasticsearch, Mongo, and Node.
...
Send a resume, cover letter, and a link to your GitHub/CodePlex/BitBucket profile if you have one, along with salary requirements, to jobs@ngpvan.com.  (All emails to that address are reviewed by engineering staff here - we just don't want to get our personal emails spammed.)
